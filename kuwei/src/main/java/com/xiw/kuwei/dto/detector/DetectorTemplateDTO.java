...
public class DetectorTemplateDTO extends DetectorTemplate  {
    private static final long serialVersionUID = 1762398383743506184L;
    ...
    * 参数数量 起始
    */
    @BindQuery(comparison = Comparison.GE, field = "parameterCount")
    private Long parameterCountBegin;

    /**
    * 参数数量 截止
    */
    @BindQuery(comparison = Comparison.LE, field = "parameterCount")
    private Long parameterCountEnd;
